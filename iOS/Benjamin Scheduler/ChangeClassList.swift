...
class ChangeClassList: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let vc : AnyObject! = self.storyboard!.instantiateViewControllerWithIdentifier("ChangeClasses")
        
        var classSelected = self.classArray[indexPath.row] as! String
        print("Current Class - " + currentClassSelected)
        
        if(changeClassSelected == "A"){
            print("A - " + classSelected)
            changeClasses[0] = self.classArray[indexPath.row] as! String
            self.showViewController(vc as! ChangeClasses, sender: vc)
            print(changeClasses)
        }
        else if(changeClassSelected == "B"){
            print("B - " + classSelected)
            changeClasses[1] = self.classArray[indexPath.row] as! String
            self.showViewController(vc as! ChangeClasses, sender: vc)
            print(changeClasses)
            
        }
        else if(changeClassSelected == "C"){
            print("C - " + classSelected)
            changeClasses[2] = self.classArray[indexPath.row] as! String
            self.showViewController(vc as! ChangeClasses, sender: vc)
            print(changeClasses)
            
        }
        else if(changeClassSelected == "D"){
            print("D - " + classSelected)
            changeClasses[3] = self.classArray[indexPath.row] as! String
            self.showViewController(vc as! ChangeClasses, sender: vc)
            print(changeClasses)
            
        }
        else if(changeClassSelected == "E"){
            print("E - " + classSelected)
            changeClasses[4] = self.classArray[indexPath.row] as! String
            self.showViewController(vc as! ChangeClasses, sender: vc)
            print(changeClasses)
            
        }
        else if(changeClassSelected == "F"){
            print("F - " + classSelected)
            changeClasses[5] = self.classArray[indexPath.row] as! String
            self.showViewController(vc as! ChangeClasses, sender: vc)
            print(changeClasses)
            
        }
        else if(changeClassSelected == "G"){
            print("G - " + classSelected)
            changeClasses[6] = self.classArray[indexPath.row] as! String
            self.showViewController(vc as! ChangeClasses, sender: vc)
            print(changeClasses)
