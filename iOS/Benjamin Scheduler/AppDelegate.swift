...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func handleShortcut( shortcutItem:UIApplicationShortcutItem ) -> Bool {
        ...
        if( shortcutItem.type == "com.benjaminscheduler.view-schedule" ) {
        ...
        if( shortcutItem.type == "com.benjaminscheduler.view-news" ) {
            var check = 0
            ...
            if(self.window?.keyWindow.boolValue == true) {
                var storyboard2 = grabStoryboard()
                var initialViewController2 = storyboard.instantiateViewControllerWithIdentifier("MainTabBarController") as! MainTabBarController
                initialViewController2.selectedIndex = 1
